...
|:--------:|---------|-------------|-----------|
| :one: | [Nakagwawa Safest Path during Earthquakes](https://github.com/prathimacode-hub/Nakagawa--Safest_Path_During_Earthquakes)| <br>  <br>An Interactive WebApp to devise safest path in Nakagawa-Ku region, Japan during natural disasters like Earthquakes, Tsunamis and Floods that helps in prioritizing the citizen's safety in risk prone zones.<br> | [@prathimacode-hub/Treksy](https://github.com/prathimacode-hub/Nakagawa--Safest_Path_During_Earthquakes) |
| :two: | [Water Quality Monitoring Dashboard](https://github.com/prathimacode-hub/Water-Quality-Monitoring)| <br>  <br>Water Quality Monitoring Dashboard for Kutch region that visualizes the parameters to determine the water quality according to the standards.<br> | [@prathimacode-hub/Water-Quality-Monitoring](https://github.com/prathimacode-hub/Water-Quality-Monitoring) |
| :three: | [AI for Road Safety in India](https://github.com/prathimacode-hub/AI-For-Road-Safety)| <br> <br>AI for Road Safety helps in overcoming accidental challenges using body language and past accidental data. <br> | [@prathimacode-hub/AI-For-Road-Safety](https://github.com/prathimacode-hub/AI-For-Road-Safety) |
